...
const CREATE_TABLES = [
  ...
  `CREATE TABLE IF NOT EXISTS manutencoes (id TEXT PRIMARY KEY, vehicle_id TEXT NOT NULL, tipo TEXT NOT NULL, descricao TEXT NOT NULL, data TEXT NOT NULL, km_atual INTEGER, proximo_km INTEGER, custo REAL NOT NULL, oficina TEXT NOT NULL, observacao TEXT, status TEXT NOT NULL, created_at TEXT)`,
