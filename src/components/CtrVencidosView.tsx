      ...
      const res = await fetch("/api/ctr/processar", {
        ...
        body: JSON.stringify({
          ...
          dados: {
            ...
            geradorRua: registro.gerador_rua,
            geradorNum: registro.gerador_num,
            geradorCep: registro.gerador_cep,
            obraEndereco: registro.obra_endereco,
            obraRua: registro.obra_rua,
            obraNum: registro.obra_num,
            obraBairro: registro.obra_bairro,
            obraCidade: registro.obra_cidade,
            obraCep: registro.obra_cep,
          },
        }),
      });
      const data = await res.json();
